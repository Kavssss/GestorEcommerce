...
public class ModalOpcoesController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
    	...
    	cbCanal.setItems(FXCollections.observableArrayList(
    			Arrays.asList(Constants.LOJA.SHOPEE,
    					Constants.LOJA.MERCADO_LIVRE_CLASSICO,
    					Constants.LOJA.MERCADO_LIVRE_PREMIUM)));
    }
    ...
    void onCanalAction(ActionEvent event) {
		...
		if (selection != null &&
				(selection.equals(Constants.LOJA.MERCADO_LIVRE_CLASSICO) || selection.equals(Constants.LOJA.MERCADO_LIVRE_PREMIUM)))
